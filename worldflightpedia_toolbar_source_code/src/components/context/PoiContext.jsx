...
export function PoiProvider({ children }) {
  ...
  // NOTE: Per request, do not persist the POI list or the selected POI
  // to localStorage. POI state is kept fully in memory during the
  // application lifecycle and is intentionally not saved to disk.
